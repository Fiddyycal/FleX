...
public class BadgeCache extends LinkedCache<Badge, String> {
	...
	public boolean load() {
		...
		this.add(new Badge('➀', "ONE_YEAR_VETARAN", "Wanderer", Tier.TIER_THREE, "Achieved playing the network for 1 year"));
		this.add(new Badge('➁', "TWO_YEAR_VETARAN", "Regular", Tier.TIER_TWO, "Achieved playing the network for 2 consecutive years"));
		this.add(new Badge('➂', "THREE_YEAR_VETARAN", "Pro", Tier.TIER_ONE, "Achieved playing the network for 3 consecutive years"));
		this.add(new Badge('➃', "FOUR_YEAR_VETARAN", "Legend", Tier.TIER_ONE, "Achieved playing the network for 4 consecutive years"));
