...
public class OverwatchReplay extends Recording {

	private boolean anonymous = false;
	
	public OverwatchReplay(Report report, @Nullable FleXPlayer... record) {
	...
	public OverwatchReplay(Report report, boolean anonymous, FleXPlayer... watchers) {
